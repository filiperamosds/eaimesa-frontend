...
- Kanban: **Imprimir novos na térmica** conecta uma vez; pedidos `pending` que chegarem no poll saem sozinhos. Pedidos que já estavam na fila não reimprimem. Monitor Painel imprime só os itens da estação.
