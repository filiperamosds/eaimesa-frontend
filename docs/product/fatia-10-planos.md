...
3. Nos últimos 3 dias do trial (ou com status `past_due`): banner no painel + item **Pagamento**. Antes disso, `/painel/pagamento` e o bloco em **Meu bar** ainda funcionam. Cartão ou PIX; no stub (~2s) vira `active` por 30 dias. No Asaas: [fatia 12](fatia-12-pagamento-asaas.md).
