...
6. Quem abre a mesa fica com a taxa de serviço daquela ocupação. `/painel/financeiro` lista o valor por funcionário ([ADR-032](../decisions/ADR-032-taxa-garcom-mesa.md)).
