...
4. Seleciona uma conta → **A receber** em destaque, itens e **Imprimir** (cupom de conferência na tela / impressora do aparelho). **Adicionar pedido**: escolhe categorias (só aí há **Cancelar**), soma itens de várias categorias (ex. bebida + petisco) e **Lança** um pedido.
