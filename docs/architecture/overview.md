...
| `staging` | Piloto 1 bar | GitHub Actions em `develop` → FTP Hostinger ([ADR-017](../decisions/ADR-017-github-actions-hostinger.md)) |
| `prod` | SaaS | Hostinger; pipeline em `main` ainda não |
