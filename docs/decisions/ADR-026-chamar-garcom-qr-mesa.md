...
Liberar CRUD de mesas **só para QR + chamada** (`GET/POST/PATCH/DELETE /v1/owner/tables`) no `kind=cardapio` quando a feature existir — sem claim, staff, Kanban ou pedido. Limite sugerido: mesmo **15** ativas.
