...
- `POST /v1/billing/checkout` **stub** (driver `immediate`): sem gateway; espera **2s** e responde `status: success` (vigência 30 dias). Front escolhe cartão/PIX; **não** envia PAN.
