...
Fatia atual: **grupos de impressão**; fatias 1–19 no repo.
...
8. [Modelo de dados](data/schema.md) — entidades fatia 1–19 + planejadas
9. [API](api/endpoints.md) — REST fatia 1–19 + contrato futuro
