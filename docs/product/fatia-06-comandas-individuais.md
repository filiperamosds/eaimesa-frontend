...
4. Seleciona uma conta → **A receber** em destaque, itens e **Imprimir na térmica** (ESC/POS no USB; o Chrome pede a POS80 uma vez). Não use o diálogo do sistema na POS80: o Mac manda A4/PostScript e ela imprime código. **Adicionar pedido**: escolhe categorias (só aí há **Cancelar**), soma itens de várias categorias (ex. bebida + petisco) e **Lança** um pedido.
